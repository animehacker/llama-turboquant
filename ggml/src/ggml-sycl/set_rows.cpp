...
static void set_rows_sycl(ggml_backend_sycl_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    switch (dst->type) {
        ...
        case GGML_TYPE_TQ3_0:
            set_rows_sycl_q<TIdx, block_tq3_0, 32, cpy_blck_f32_tq3_0>(src0_d, src1_d, (block_tq3_0 *)dst->data, ne00, ne01, ne02, ne03, ne10, ne11, ne12, ne13, nb00, nb01, nb02, nb03, nb10, nb11, nb12, nb13, nb1, nb2, nb3, stream);
            break;
